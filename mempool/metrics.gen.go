...
func PrometheusMetrics(namespace string, labelsAndValues ...string) *Metrics {
	...
	return &Metrics{
		...
		RedundancyAdjustmentThreshold: prometheus.NewGaugeFrom(stdprometheus.GaugeOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "redundancy_adjustment_threshold",
			Help:      "",
		}, labels).With(labelsAndValues...),
...
func NopMetrics() *Metrics {
	return &Metrics{
		...
		RedundancyAdjustmentThreshold: discard.NewGauge(),
